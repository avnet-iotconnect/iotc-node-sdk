...
const holdOfflineDataTime = 10; // In Second
...
const infoLog = {
    ...
    "INFO_CM10" : "Command acknowledgement success", // new
	"INFO_CM11" : "Command : 0x17 : DATA_FREQUENCY_UPDATE", // new
...
module.exports = {
	...
	edgeFaultDataFrequency: edgeFaultDataFrequency
}