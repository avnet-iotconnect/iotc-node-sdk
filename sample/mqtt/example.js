...
var sdkOptions = {
    // "certificate" : { // Self signed or CA signed device only
    //     "SSLKeyPath"	: "/var/www/html/sdk-msg-2.1/sw-tt-iotconnect-sdk-node/sample/mqtt/crt/hliotShpere01/device.key",
    //     "SSLCertPath"   : "/var/www/html/sdk-msg-2.1/sw-tt-iotconnect-sdk-node/sample/mqtt/crt/hliotShpere01/device.pem",
    //     "SSLCaPath"     : "/var/www/html/sdk-msg-2.1/sw-tt-iotconnect-sdk-node/sample/mqtt/crt/hliotShpere01/rootCA.pem"
    // },
    "offlineStorage": {
    ...
    // "devicePK": "ZmpmZ2pmZ2pmZ2pmZ2pmZ2pmZ2pmZ2pnampmZ2pmZ2pmZ25nZGRnaHJzZ3JocXJ3ZXJ3cjQzNTM0NjYzNDY1Ng==", // For Symmetric Key Auth type support
            ...
            rl.question('Enter SID : ', function (sId) {
                ...
                if(sdkOptions.certificate){
                    try {
                        ...
                        async.forEachSeries(Object.values(sdkOptions.certificate), function (filePath, cb_inner) {
...
var twinChangeCommandCBFunc = function twinChangeCommandCBFunc(data){
    ...
    if(data.desired) {
        async.forEachSeries(Object.keys(data.desired) , function (property, callbackAtt) {
            if(property == "$version"){
                callbackAtt();
            } else {
...
//*** */ To discard the SDK object the device ***
// setTimeout(() => {
//     dispose();
// }, 50000);

// setTimeout(() => {
//     console.log("Retry disconnect call...");
//     try {
//         disconnectDevice();
//     } catch (error) {
//         console.log(error);
