...
class Mqtt {
    constructor(uniqueId, sdkOptions = "", callback) {
        this.commonLib = "";
        this.UNIQUE_ID = uniqueId;
        this.SID = sdkOptions.sId;
        ...
        this.LOG_PATH = "./logs/offline/" + (this.SID ||  sdkOptions.cpId) + "_" + uniqueId + "/";
        sdkOpt['logPath'] = this.LOG_PATH;
        sdkOpt['cpId'] = sdkOptions.cpId;
        sdkOpt['env'] = sdkOptions.env;
        sdkOpt['pf'] = sdkOptions.pf;

        this.commonLib = new CommonFunctions(this.SID, uniqueId, sdkOpt);
        if (!this.SID) {
        ...
        if ((this.SID || sdkOpt.cpId) && uniqueId && !sdkOpt.offlineStorage.offlineProcessDisabled) {
            var self = this;
